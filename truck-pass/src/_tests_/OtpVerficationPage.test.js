...
describe('OtpVerificationPage', () => {
    const setup = () => render(_jsx(MemoryRouter, { initialEntries: [{ pathname: '/otp', state: { email: 'test@example.com' } }], children: _jsx(Routes, { children: _jsx(Route, { path: "/otp", element: _jsx(OtpVerificationPage, {}) }) }) }));
