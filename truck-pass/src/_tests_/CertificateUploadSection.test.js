...
const setup = (props = {}) => render(_jsx(CertificateUploadingSection, { showUploadingBlock: false, setShowUploadingBlock: mockSetShowUploadingBlock, setFileUploaded: mockSetFileUploaded, setDataInFile: mockSetDataInFile, clickableText: 'Browse', fileUploadErrorMsg: "", setFileUploadErrorMsg: mockSetCpcUploadErrorMsg, ...props }));
// Mocks FileReader
