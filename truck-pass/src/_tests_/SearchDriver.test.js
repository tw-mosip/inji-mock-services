...
jest.mock("../../components/Tooltip", () => (props) => (_jsx("span", { children: props.helpText })));
...
jest.mock("../../services/relyingPartyService", () => ({
    __esModule: true,
    default: {
        get_driver_information: (...args) => mockGetDriverInformation(...args),
    },
}));
describe("SearchDriver component", () => {
    ...
    const setup = () => render(_jsx(MemoryRouter, { children: _jsx(SearchDriver, {}) }));
