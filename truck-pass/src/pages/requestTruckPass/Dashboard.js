...
export const Dashboard = () => {
    ...
    return (_jsxs("div", { className: "flex flex-col pt-9 font-inter h-auto bg-[#ECF5FF]", children: [_jsxs("div", { className: 'flex justify-between items-center px-20 mb-4', children: [_jsx("h1", { className: 'font-[600] text-[23px] text-[#27181a]', children: t('dashBoard.myDashBoard') }), _jsx("button", { onClick: () => newTruckPassRequest(), className: 'bg-[#006DE7] font-medium text-[13px] px-3.5 py-2.5 text-[#FFFFFF] border rounded-md cursor-pointer hover:border-[#006DE9] hover:shadow-lg', children: t('dashBoard.newTruckPassRequest') })] }), _jsxs("div", { className: "bg-[url('../assets/landingpage_bg.png')] w-full px-20", children: [_jsx("div", { className: 'flex bg-[#FFFFFF] px-6 h-[69px] items-center bottom border border-[#DEDEDE] rounded-t-[8px]', children: _jsx("p", { className: 'font-semibold text-[16px] text-[#181D27]', children: t('dashBoard.requestTruckPass') }) }), _jsxs("table", { children: [_jsx("thead", { children: _jsx("tr", { children: tableHeaders.map((header, id) => {
                                        return (_jsx("th", { className: "bg-[#FFFFFF] gap-x-2 w-[15%] text-[#181D27] text-sm font-[400]", children: _jsxs("div", { id: `${header.title}_header`, className: `flex gap-x-1.5 p-4 mx-2 items-center text-left}`, children: [t(header.title), _jsxs("div", { className: 'flex flex-col items-center', children: [_jsx("img", { src: sortUpIcon, alt: "sorting icon", className: 'h-2 font-[600] place-self-center' }), _jsx("img", { src: sortDownIcon, alt: "sorting icon", className: 'h-2 font-[600] place-self-center' })] })] }) }, id));
                                    }) }) }), _jsx("tbody", { children: listOfTruckPassRequests.map((request, id) => {
                                    const currentStatus = statusBg(request.status) ?? { label: '', statusClass: '', pointerBg: '' };
                                    const { label, statusClass, pointerBg } = currentStatus;
                                    return (_jsxs("tr", { className: `bg-[#FFFFFF] border-t border-[#E5EBFA] text-[0.8rem] break-words h-[54px] text-[#191919] cursor-pointer`, children: [_jsx("td", { className: `px-6 font-[600]`, children: request.requestId }), _jsx("td", { className: `px-6 w-[360px]`, children: request.driverName }), _jsx("td", { className: `px-6`, children: request.licenceNumber }), _jsxs("td", { className: `${statusClass} flex space-x-1 border text-xs font-[400] mt-3.5 px-1.5 ml-4 h-[28px] items-center`, children: [_jsx("span", { className: `flex h-1.5 w-1.5 rounded-2xl ${pointerBg}` }), _jsx("p", { className: 'font-[600]', children: label })] }), _jsx("td", { className: `px-6`, children: request.date })] }, id));
                                }) })] })] }), _jsx("footer", { className: 'text-sm text-[#717171] place-self-center bg-transparent pt-10 pb-6 font-inter', children: t('footer.footerText') })] }));
};
