...
export const DropDownSelection: React.FC<DropDownSelectionProps> = ({ data, setItemSelected, placeHolder, selectingVehicleType, selectingAxelSize, selectingOriginCountry, selectingDestinationCountry, selectOriginBorder, selectDestinationBorder }) => {
    ...
    return (
        <div className="relative">
            ...
            >
                {selected
                    ? (selected.type || selected.size || selected.country || selected.departurePoint || selected.arrivalPoint)
                    : placeHolder
                }
