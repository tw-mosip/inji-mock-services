...
export default function authorizeHandler(req, res) {
  ...
  const loginAction = hasExplicitVersion(req) ? `/${version}/as/login` : "/as/login";
  console.log("Looking for HTML at:", path.resolve("as/login-page.html"));
  ...
  const template = fs.readFileSync(
    path.resolve("as/login-page.html"),
    "utf8"
  );
